...
%file name format
OF_fmt='/Users/mehdi/Downloads/ActiveGel_Murell/OpticalFlow/murrell_contractility_2/dt4/FlowField_%03d.mat';
...
%outputname
Response_name='/Users/mehdi/Downloads/ActiveGel_Murell/OpticalFlow/murrell_contractility_2/Vortical_dt4_frame60.csv';
...
if Ind_files==1
    ...
    load(OF_name);
    u=flowFiled(frames(1)).v;
    v=flowFiled(frames(1)).u;
end
